...
Tstart = tr.euler_matrix(0, np.pi, 0)
Tstart[:3,3] = cube_centroid
qgrasp = None
for pitch in np.arange(0, np.deg2rad(181), np.deg2rad(10)):
  Tgrasp = np.dot(Tstart, tr.euler_matrix(0, pitch, 0))
